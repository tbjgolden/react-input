...
function $b3e8d5c5f32fa26afa6df1b81f09b6b8$var$setupGlobalEvents() {
  ...
  let onTransitionStart = (e) => {
    ...
    let transitions =
      $b3e8d5c5f32fa26afa6df1b81f09b6b8$var$transitionsByElement.get(e.target);

    if (!transitions) {
      transitions = new Set();
      $b3e8d5c5f32fa26afa6df1b81f09b6b8$var$transitionsByElement.set(
        e.target,
        transitions,
  ...
  let onTransitionEnd = (e) => {
    ...
    if (properties.size === 0) {
      ...
      $b3e8d5c5f32fa26afa6df1b81f09b6b8$var$transitionsByElement.delete(
        e.target,
      );
...
const $a3ff51240de6f955c79cf17a88e349$export$PressResponderContext =
  /*#__PURE__*/ react.createContext(null);

$a3ff51240de6f955c79cf17a88e349$export$PressResponderContext.displayName =
...
function $d01f69bb2ab5f70dfd0005370a2a2cbc$var$triggerChangeHandlers(
  modality,
  e,
) {
...
function $d01f69bb2ab5f70dfd0005370a2a2cbc$var$handleFocusEvent(e) {
  ...
  if (
    !$d01f69bb2ab5f70dfd0005370a2a2cbc$var$hasEventBeforeFocus &&
    !$d01f69bb2ab5f70dfd0005370a2a2cbc$var$hasBlurredWindowRecently
  ) {
...
function $d01f69bb2ab5f70dfd0005370a2a2cbc$var$setupGlobalFocusEvents() {
  if (
    ...
    $d01f69bb2ab5f70dfd0005370a2a2cbc$var$hasSetupGlobalListeners
  ) {
    return;
  ...
  document.addEventListener(
    'keydown',
    $d01f69bb2ab5f70dfd0005370a2a2cbc$var$handleKeyboardEvent,
    true,
  );
  document.addEventListener(
    'keyup',
  ...
  document.addEventListener(
    'click',
    $d01f69bb2ab5f70dfd0005370a2a2cbc$var$handleClickEvent,
    true,
  ...
  window.addEventListener(
    'focus',
    $d01f69bb2ab5f70dfd0005370a2a2cbc$var$handleFocusEvent,
    true,
  );
  window.addEventListener(
    'blur',
    $d01f69bb2ab5f70dfd0005370a2a2cbc$var$handleWindowBlur,
    false,
  );
  ...
  if (typeof PointerEvent !== 'undefined') {
    document.addEventListener(
      'pointerdown',
      $d01f69bb2ab5f70dfd0005370a2a2cbc$var$handlePointerEvent,
      true,
    );
    document.addEventListener(
      'pointermove',
